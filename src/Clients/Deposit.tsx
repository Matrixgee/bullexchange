            ...
            <div className="flex items-center mb-4">
              ...
              <div>
                <h1 className="text-3xl font-bold text-white mb-2 flex items-center max-md:text-xl">
                  {/* <Wallet className="w-8 h-8 mr-3 text-red-400" /> */}
            ...
            <div className="grid lg:grid-cols-3 gap-8">
              ...
              <div className="lg:col-span-2 space-y-6">
                      ...
                      >
                        ...
                        <div className="space-y-1 text-sm">
                          <p className="text-slate-300">
                            Fee:{" "}
                            <span className="text-red-300">{method.fee}</span>
                          </p>
                          <p className="text-slate-300">
                            Min:{" "}
                ...
                <div className="bg-slate-900/40 backdrop-blur-sm border border-red-500/20 rounded-xl p-6 hover:border-red-400/30 transition-all duration-300">
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      min="10"
                      className="w-full pl-10 pr-4 py-4 bg-slate-900/50 border border-red-500/20 rounded-lg text-white placeholder-slate-400 focus:border-red-400/50 focus:outline-none focus:ring-2 focus:ring-red-400/20 transition-all"
                    />
                  </div>
                ...
                <div className="bg-slate-900/40 backdrop-blur-sm border border-red-500/20 rounded-xl p-6 hover:border-red-400/30 transition-all duration-300">
                  ...
                  <div className="bg-slate-900/60 border border-red-500/10 rounded-lg p-4">
                    <div className="flex items-center justify-between mb-2">
                      ...
                      <button
                        ...
                        className="flex items-center space-x-1 text-red-300 hover:text-white transition-colors px-2 py-1 rounded hover:bg-red-500/10"
                      >
                        {copied ? (
                    ...
                    <div className="break-all text-white font-mono text-sm bg-slate-900/80 p-3 rounded border border-red-500/10 hover:bg-slate-900/60 transition-colors">
            ...
            <div className="max-w-4xl mx-auto">
              <div className="grid lg:grid-cols-2 gap-8">
                ...
                <div className="bg-slate-900/40 backdrop-blur-sm border border-red-500/20 rounded-xl p-6 hover:border-red-400/30 transition-all duration-300">
                  ...
                  {!proof ? (
                    <div className="border-2 border-dashed border-red-500/30 rounded-lg p-8 text-center hover:border-red-400/50 transition-colors">
                      ...
                      <label className="cursor-pointer">
                        <input
                          ...
                          className="hidden"
                        />
                        <span className="inline-flex items-center px-4 py-2 bg-red-500/20 text-red-400 rounded-lg hover:bg-red-500/30 transition-colors">
                    ...
                    <div className="space-y-4">
                      <div className="flex items-center justify-between p-4 bg-slate-900/60 rounded-lg border border-red-500/20">
