...
const Support = () => {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer:
        "We do not charge fees for deposits. Withdrawal fees may apply depending on the method chosen.",
    },
    {
      question: "How are profits calculated and distributed?",
      answer:
        "Profits are calculated based on your investment package and distributed according to the schedule specified in your plan.",
    },
  ];
        ...
        <div className="p-6 pb-20">
          ...
          <div className="mb-8">
            <h1 className="text-3xl font-bold text-white mb-2 flex items-center">
              <MessageCircle className="w-8 h-8 mr-3 text-red-400" />
              Support Center
            </h1>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            <div className="space-y-6">
              <div className="bg-slate-900/40 backdrop-blur-sm border border-red-500/20 rounded-xl p-6">
                ...
                <div className="space-y-4">
                  ...
                  <button
                    ...
                    className="w-full py-3 bg-gradient-to-r from-red-400 to-red-600 text-white font-semibold rounded-lg hover:from-red-500 hover:to-red-700 transition-all disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center space-x-2 shadow-lg"
                ...
                <div className="space-y-3">
                  <div className="flex items-center space-x-3">
                    ...
                    <span className="text-slate-300">
                      support@bullsmarketexchange.com
                    </span>
                  </div>
                  <div className="flex items-center space-x-3">
            ...
            <div className="bg-slate-900/40 backdrop-blur-sm border border-red-500/20 rounded-xl p-6">
              ...
              <div className="space-y-4">
                {faqs.map((faq, index) => (
                  <div
                    key={index}
                    className="border border-red-500/10 rounded-lg bg-slate-900/60 overflow-hidden"
                  >
                    <button
              ...
              <div className="mt-6 p-4 bg-red-500/10 border border-red-500/20 rounded-lg">
                <p className="text-sm text-slate-300">
                  ...
                  <br />
                  Use the contact form to get personalized assistance from our
                  support team.
                </p>
              </div>
            </div>
