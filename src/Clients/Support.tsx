        ...
        <div className="p-6 pb-20">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div className="bg-slate-900/40 backdrop-blur-sm border border-red-500/20 rounded-xl p-6">
              ...
              <div className="space-y-4">
                {faqs.map((faq, index) => (
                  <div key={index} className="border border-red-500/10 rounded-lg bg-slate-900/60 overflow-hidden">
                    <button
              ...
              <div className="mt-6 p-4 bg-red-500/10 border border-red-500/20 rounded-lg">
                <p className="text-sm text-slate-300">
                  <span className="text-red-400 font-medium">Can't find what you're looking for?</span> 
                  <br />
