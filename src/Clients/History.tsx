          ...
          
          {
            ...
            <div className="p-6 border-b border-red-500/20">
              <div className="flex items-center justify-between">
                ...
                <button className="flex items-center space-x-2 text-red-400 hover:text-red-300 transition-all duration-300 bg-red-500/10 px-3 py-2 rounded-lg border border-red-500/20 hover:bg-red-500/20 hover:border-red-400/40 hover:scale-105">
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-4">
                      <div className={`p-3 rounded-xl shadow-lg ${
                        transaction.type === 'deposit' ? 'bg-gradient-to-br from-red-400 to-red-600' :
                        transaction.type === 'profit' ? 'bg-gradient-to-br from-red-500 to-red-600' :
                    ...
                    <div className="text-right">
                      <p className={`font-semibold text-lg ${
                        transaction.type === 'profit' ? 'text-red-400' :
