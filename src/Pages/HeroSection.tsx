    ...
    <section className="relative overflow-hidden py-20 md:py-32 ">
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="text-center max-w-4xl mx-auto">
          <motion.div 
            className="text-4xl md:text-6xl font-bold mb-6 bg-gradient-to-r from-white via-gray-200 to-red-400 bg-clip-text text-transparent leading-tight"
          ...
          >
            Join thousands of investors who trust Bull Exchange for their financial growth. 
            Start building your wealth with our cutting-edge investment platform.
          </motion.p>
          <motion.div 
