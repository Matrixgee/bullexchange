...
const UserDashboardHeader: React.FC<UserHeaderProps> = ({ active, setActive }) => {
  ...
  return (
    <div className="header-container">
      {/* Animated background */}
      <div className="absolute inset-0 bg-gradient-to-r from-red-900/95 via-red-900/40 to-red-900/95 backdrop-blur-xl"></div>
      <div className="absolute inset-0 bg-gradient-to-b from-red-400/5 to-red-500/5"></div>

      {/* Floating particles */}
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-2 left-20 w-16 h-16 bg-red-400/10 rounded-full blur-xl animate-pulse"></div>
        <div className="absolute top-4 right-32 w-12 h-12 bg-red-500/10 rounded-full blur-xl animate-pulse delay-1000"></div>
      </div>
